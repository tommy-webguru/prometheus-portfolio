...
import { Brain, Zap, Target, Eye, MessageSquare, BarChart3, CheckCircle, ArrowRight, DollarSign, TrendingUp, Database, Cpu, Network } from 'lucide-react';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { features, technologies, caseStudies, process, pricing, aiCapabilities } from './constants';

// Icon mapping for Lucide icons
const iconMap: Record<string, React.ComponentType<any>> = { Brain, Eye, MessageSquare, BarChart3, Target, Network, Cpu, Database, Zap, DollarSign, TrendingUp };
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {pricing.map((plan, index) => (
              <motion.div
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
                viewport={{ once: true }}
                className={`bg-gray-50 dark:bg-gray-800 rounded-xl p-8 shadow-lg relative ${plan.popular ? 'ring-2 ring-purple-600 dark:ring-purple-400' : ''
                  }`}
              >
                {plan.popular && (
                ...
                <Link href="/contact">
                  <Button
                    className={`w-full py-3 rounded-lg font-medium transition-all duration-300 ${plan.popular
